...
def main():
    ...
    # *** k. Open a 'mywords.txt' game play file
    game_play_file = open("mywords.txt", "w")
    ...
    while(keep_playing):
        ...
        # k. Record game play.
        # *** Before the loop open a game play file

        # Record this word, the player's word, whether it was valid, and score
        game_play = word + "," + little_word + "," + str(is_valid and is_real) + "," + str(word_score)
        game_play_file.write(game_play + "\n") # don't forget the newline '\n'
    ...
    # *** j. Don't forget to close the game play file!
    game_play_file.close()
